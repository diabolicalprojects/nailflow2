        ...
        <div className="animate-fade-in max-w-6xl mx-auto">
            ...
            {showForm && (
                <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
                    ...
                    <div className="bg-white rounded-[3rem] w-full max-w-xl max-h-[90vh] overflow-y-auto z-10 shadow-2xl relative animate-in fade-in zoom-in duration-300 scrollbar-hide">
